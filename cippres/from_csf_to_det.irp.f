...
subroutine from_csf_to_det(irun)
 ...
 print*,'*************************************'
 write(*,*) "ccjia: I'm here 1, from csf to det" 
 write(*,*) "ccjia: I'm here 2, from csf to det"
 write(*,*) "ccjia: I'm here 3, from csf to det"
 write(*,*) "ccjia: I'm here 4, from csf to det"
 write(*,*) "ccjia: I'm here 5, from csf to det"
 idet_tmp = 0
 do i = 1, n_csf_cippres(irun) ! first loop on the csf of the space ispace 
   do k = 1, n_det_csf_cippres(i,irun) ! then on the determinants belonging to the ith CSF of space ispace
    write(*,*) "ccjia: n_csf_cippres(irun), n_det_csf_cippres(i,irun).",i,k,n_csf_cippres(irun),n_det_csf_cippres(i,irun)
    write(*,*) "ccjia: irun,idet_tmp.",irun,idet_tmp
    idet_tmp += 1
   enddo 
  enddo
 ...
 write(*,*) "ccjia: irun,idet_tmp.",irun,idet_tmp
 N_det = idet_tmp 
 write(*,*) "ccjia: N_det.",N_det
! N_states = n_csf_max
 N_states = n_sta_cistate_analysis
 touch N_det N_states
!call system('touch N_det N_states')
write(*,*) "ccjia: I'm here 6, from csf to det, N_det N_states"
 print*,'N_det,psi_det_size',N_det,psi_det_size
write(*,*) "ccjia: I'm here, from csf to det,N_det,psi_det_size.",N_det,psi_det_size
 idet_tmp = 0
write(*,*) "ccjia: from csf to det,N_det,N_states",N_det,N_states
write(*,*) "ccjia: I'm here 7, from csf to det, idet_tmp.",idet_tmp
 do i = 1, n_csf_cippres(irun) ! first loop on the csf of the space ispace 
   do k = 1, n_det_csf_cippres(i,irun) ! then on the determinants belonging to the ith CSF of space ispace
    idet_tmp += 1
   ...
   enddo 
  enddo
write(*,*) "ccjia: I'm here 8, from csf to det"
 print*,'idet_tmp          = ',idet_tmp
 print*,'N_det,N_states    = ',N_det,N_states
!!!comment by ccjia: 
touch psi_det psi_coef 
!call system('touch psi_det psi_coef')
write(*,*) "ccjia: I'm here 9, from csf to det, psi_det psi_coef"
...
write(*,*) "ccjia: I'm here 10, from csf to det, open cistates_det.txt"
 do i = 1, N_det
  write(10,*)i
